...
/**
 * this way lead to getImage() function not invoked until getCatchPhrase() complete
 * this lead to increase the time og getting complete response
 */
...
/**
 * this way lead to getImage() and getCatchPhrase() function invoked together
 * this lead to decrease time
 */
